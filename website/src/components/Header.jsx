      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-4">
            <img src={getAssetUrl('assets/tcd-logo-crest.png')} alt="Trinity College Dublin" className="h-14 w-auto object-contain" />
            <div className="hidden sm:flex flex-col  pl-4 py-1 h-10 justify-center">
